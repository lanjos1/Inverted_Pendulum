% original: <https://github.com/imkishan96/Inverted_Pendulum>

M = 0.123 + 0.025 + 0.03;    % Mass of cart (Kg)
m = 0.025 + 0.066;    % Mass of pendulum(Kg) 
b = 0.5;    % Co-efficient of Friction(N*sec/m)
l = 0.235;    % length of pendulum(m)
...
Q(2,2) = 0;
Q(3,3) = 1000;  % wokring 1000  angle
Q(4,4) = 0;
R = 0.0001;        % working 0.1   force
